...
void I2CMaster_Init(void) 
{
	...
	{	
		...
		I2C_Handle.Init.Timing            = 0x00C0EAFF;//100KHz
    ...
    HAL_I2CEx_ConfigDigitalFilter(&I2C_Handle, 0);
	}
}
/**
...
//    I2Cx_WriteMultiple(&I2C_Handle, OV2640_DEVICE_WRITE_ADDRESS, (uint16_t)Addr, I2C_MEMADD_SIZE_8BIT,(uint8_t*)&Data, 1);
  ...
  status = HAL_I2C_Mem_Write(&I2C_Handle, OV2640_DEVICE_ADDRESS, (uint16_t)Addr, I2C_MEMADD_SIZE_8BIT, (uint8_t*)&Data, 1, 100);
